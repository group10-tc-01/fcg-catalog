...
dotnet user-secrets set "ConnectionStrings:DefaultConnection" "Server=127.0.0.1;Database=fcg_catalog;User Id=sa;Password=<sua-senha>;TrustServerCertificate=True;"
